  ...
  useEffect(() => {
    if (jobId) {
      const interval = setInterval(() => {
        axios.get(`https://multiproduct-4af75c62b4d1.herokuapp.com/job-status/${jobId}`)
          .then(response => {
  ...
  const getRecommendations = async () => {
    ...
    try {
      const response = await axios.post(
        "https://multiproduct-4af75c62b4d1.herokuapp.com/getRecommendation",
        {
          selection: {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mt-8">
        ...
        <div className="flex">
          <div className="bg-white p-4 rounded-md shadow-md mt-4 w-2/3">
            <h3 className="text-lg font-bold mb-2">Bar Chart for User History</h3>
            <CustomBarChart
              data={barChartData}
              detailedItems={detailedItems}
